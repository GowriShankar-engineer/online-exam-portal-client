...
export default function CreateExam({ userInfo }) {
    ...
    const [examInfo,setExamInfo] = useState({
        ...
        "totalMarks": 50,
        "userAccountId": 1,
        "examDate": "2022-07-20 14:55:34.279741",
        "resultDate": "2022-07-20 14:55:34.279741"
    });
                        ...
                        <form className="needs-validation" noValidate>
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    <label htmlFor="firstName" className="form-label">Exam Name</label>
                                ...
                                <div className="col-sm-6">
                                    <label htmlFor="country" className="form-label">Subject</label>
                                ...
                                <div className="col-12">
                                    <label htmlFor="Question-1" className="form-label">Question 1</label>
                                ...
                                <div className="col-sm-6">
                                    <label htmlFor="lastName" className="form-label">Option 2</label>
                                ...
                                <div className="col-sm-6">
                                    <label htmlFor="firstName" className="form-label">Option 3</label>
                                ...
                                <div className="col-sm-6">
                                    <label htmlFor="lastName" className="form-label">Option 4</label>
                                ...
                                <div className="col-12">
                                    <label htmlFor="Question-1" className="form-label">Answer</label>
                                    <div className="input-group has-validation">
                                        <span className="input-group-text">1</span>
                                ...
                                <hr className="my-4" />
                                <div className="col-12">
                                    <label htmlFor="username" className="form-label">Question 2</label>
                                    <div className="input-group has-validation">
                                ...
                                <div className="col-sm-6">
                                    <label htmlFor="firstName" className="form-label">Option 1</label>
                                ...
                                <hr className="my-4" />
                                <div className="col-12">
                                    <label htmlFor="username" className="form-label">Question 3</label>
                                    <div className="input-group has-validation">
                                ...
                                <hr className="my-4" />
                                <div className="col-12">
                                    <label htmlFor="username" className="form-label">Question 4</label>
                                    <div className="input-group has-validation">
                                        <span className="input-group-text">3</span>
                                ...
                                <hr className="my-4" />
                                <div className="col-12">
                                    <label htmlFor="username" className="form-label">Question 5</label>
                                    <div className="input-group has-validation">
                                        <span className="input-group-text">3</span>
                                ...
                                <hr className="my-4" />
                                <div className="col-sm-6">
                                    <label htmlFor="firstName" className="form-label">Exam Date</label>
                                    <input type="date" className="form-control" id="examDate" placeholder='Option4' value={examInfo.examDate} onClick={(e)=>onHandleChange(e)} required />
                                    <div className="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <label htmlFor="firstName" className="form-label">Result Date</label>
                                    <input type="date" className="form-control" id="resultDate" placeholder='Option4' value={examInfo.resultDate} onClick={(e)=>onHandleChange(e)} required />
                                    <div className="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                </div>
